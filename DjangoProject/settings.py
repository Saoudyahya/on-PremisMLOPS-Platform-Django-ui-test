...
# Airflow
AIRFLOW_URL            = config("AIRFLOW_URL",            default="http://airflow-webserver.mlops-airflow.svc.cluster.local:8080")
AIRFLOW_USERNAME       = config("AIRFLOW_USERNAME",       default="admin")
AIRFLOW_PASSWORD       = config("AIRFLOW_PASSWORD",       default="admin")
